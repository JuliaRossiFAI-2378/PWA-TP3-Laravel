    ...
    public function run(): void
    {
        ...
        for($post=0;$post<count($postsVocaloid);$post++){
            DB::table('posts')->insert(
                ...
                'user' => rand(1, 26),
                'habilitated' => true,
                'imageLink' => "https://pbs.twimg.com/media/GMUmH2JW8AA74AM?format=jpg",
        ...
        for($post=0;$post<count($postsLeoneed);$post++){
            DB::table('posts')->insert(
                ...
                'user' => rand(1, 26),
                'habilitated' => true,
                'imageLink' => "https://pbs.twimg.com/media/Fno6-8ZaIAUMK1F?format=jpg",
        ...
        for($post=0;$post<count($postsMoreMoreJump);$post++){
            DB::table('posts')->insert(
                ...
                'user' => rand(1, 26),
                'habilitated' => true,
                'imageLink' => "https://pbs.twimg.com/media/GsMAhowbIAAwuaN?format=jpg",
        ...
        for($post=0;$post<count($postsVividBadSquad);$post++){
            DB::table('posts')->insert(
                ...
                'user' => rand(1, 26),
                'habilitated' => true,
                'imageLink' => "https://pbs.twimg.com/media/GlwixHTacAAsDp3?format=jpg",
        ...
        for($post=0;$post<count($postsNiigo);$post++){
            DB::table('posts')->insert(
                ...
                'user' => rand(1, 26),
                'habilitated' => true,
                'imageLink' => "https://pbs.twimg.com/media/FeOCIHyaEAI58r_?format=jpg",
